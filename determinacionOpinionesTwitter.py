...
print(frase)
frase2="We should trust scientists because they have discover new diseases cures"
#Normalización
frase = normalizacion(frase)
frase2=normalizacion(frase2)
#Eliminación de las stops words
frase = ' '.join([palabra for palabra in frase.split() if palabra not in (stopWords)])
frase2 = ' '.join([palabra for palabra in frase2.split() if palabra not in (stopWords)])
#Aplicación de stemming
frase =  ' '.join([stemmer.stem(palabra) for palabra in frase.split(' ')])
frase2 =  ' '.join([stemmer.stem(palabra) for palabra in frase2.split(' ')])
#Lematización
frase = ' '.join([lemmatizer.lemmatize(palabra) for palabra in frase.split(' ')])
print (frase)
frase2 = ' '.join([lemmatizer.lemmatize(palabra) for palabra in frase2.split(' ')])
print (frase2)
...
prediccion = modelo.predict([frase2])
print(prediccion)
if(prediccion[0]==0):
    print(">> 2No cree en el calentamiento climático...")
else:
    print(">> 2Cree en el calentamiento climático...")
